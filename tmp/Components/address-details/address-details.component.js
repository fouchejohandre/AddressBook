...
angular.
  ...
  component('addressDetails', {
    ...
    controller: ['$stateParams', '$http', '$scope', '$uibModal' ,'$state', 'AddressBookService', '$timeout',
    function AddressDetailsController($stateParams, $http, $scope, $uibModal,  $state, AddressBookService, $timeout) {
      var self = this;
      self.phoneId = 'AA'
      ...
      self.imageUploaded = function(){
        ...
        self.uploading = true;
        $timeout(function(){
          self.selectedAddress.ImageUrl = self.myImage;
          self.uploading = false;
        }, 2000);
      }
