...
angular.
  ...
  component('addressAdd', {
    ...
    controller: ['$http', '$state', 'AddressBookService', '$scope', '$timeout', function AddressAddController($http ,$state, AddressBookService, $scope, $timeout) {
      var self = this;
      self.newAddress = {};
      self.tempUserData = [];
      self.tempUserData = AddressBookService.getUser();
      self.changed = false;
      self.myImage = 'http://localhost:8000/AddressBook/Images/default.jpg';
      ...
      self.imageUploaded = function(){
        ...
        $timeout(function(){
          self.uploading = false;
          self.newAddress.ImageUrl = self.myImage;
          console.log(self.newAddress.ImageUrl);
      ...
      self.addAddress = function()
      {
        ...
        {
          self.finalImage = self.newAddress.ImageUrl;
        }
